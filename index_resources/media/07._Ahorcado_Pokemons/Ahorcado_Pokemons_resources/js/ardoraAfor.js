...
$("#ardoraQuest").html("<img id='playSound' class='imaLeft' src='Ahorcado_Pokemons_resources/media/' alt='Sound' align='left'>"+ "<p>" + questionW[indexG] + "</p>");
...
function calcMaxWidth(){for (i = 0; i < wordsG.length; i++) {var actualSize=0;actualSize=$.trim(aforWords(wordsG[i])).length*(54+9);
...
function paintbGame(){profG=profG+42+9;var leV=(actMaxWidth-($.trim(aforWords(wordsG[indexG])).length-1)*(42+19))/2;
