...
$("#help_div").html("<img tabindex='0' id='playSound' class='imaLeft' src='09._Construir_Palabras_resources/media/' alt='Play' align='left'>"+ "<p>" +ConstruPalWords(cp_que[jobindex[indexGame-1]])+ "</p>");
...
$(iDiv).css("position","absolute");$(iDiv).css("left",0);$(iDiv).css("cursor", "pointer");$(iDiv).css("margin-top",0);var imadir='09._Construir_Palabras_resources/media/'+cp_ima[jobindex[indexGame - 1]].trim();
...
var imab_dir ="09._Construir_Palabras_resources/media/b_" + cp_ima[jobindex[indexGame - 1]].trim();
