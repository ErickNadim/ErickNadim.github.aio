...
else{contexto.lineTo(parseInt(points[i][0]),parseInt(points[i][1]));}}}contexto.lineTo(sX,sY);contexto.lineWidth=1;
contexto.strokeStyle =areaColor[area];contexto.fillStyle =areaColor[area];contexto.closePath();contexto.stroke();
contexto.font = "bold 14px Georgia, Serif";contexto.setLineDash([]);
